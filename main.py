...
def parse_arguments():
    ...
    parser.add_argument('--exp', type=str, default="debug_dqn_new_metri")
    ...
    parser.add_argument('--config', default='config/tasks/Nav/easy_med/algo/bc_test.yaml', help='Configure file for this RL exp.')
    parser.add_argument('--checkpoint_path', default="checkpoints/final_models/easy_med/bc50.zip", help='Path to the trained model.')
