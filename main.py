...
def parse_arguments():
    ...
    parser.add_argument('--exp', type=str, default="test_random_easy")
    ...
    parser.add_argument('--config', default='config/tasks/Nav/easy/algo/random_test.yaml', help='Configure file for this RL exp.')
