...
def parse_arguments():
    ...
    parser.add_argument('--exp', type=str, default="nlm_dqn_debug")
    ...
    parser.add_argument('--config', default='config/tasks/Nav/medium/algo/nlmdqntest.yaml', help='Configure file for this RL exp.')
