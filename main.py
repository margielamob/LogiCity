...
def parse_arguments():
    ...
    parser.add_argument('--exp', type=str, default="easy_dqnnlm")
    ...
    parser.add_argument('--config', default='config/tasks/Nav/easy/algo/nlmdqntest.yaml', help='Configure file for this RL exp.')
