...
def parse_arguments():
    ...
    parser.add_argument('--exp', type=str, default="easymed_random")
    ...
    parser.add_argument('--config', default='config/tasks/Nav/hard/algo/random_test.yaml', help='Configure file for this RL exp.')
