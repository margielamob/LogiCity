...
def parse_arguments():
    ...
    parser.add_argument('--rule_type', type=str, default="Z3_Global", help='We support ["LNN", "Z3_Global", "Z3_Local"].')
    parser.add_argument('--rules', type=str, default="config/rules/Z3/easy/easy_rule_global.yaml", help='YAML path to the rule definition.')
    # logger
