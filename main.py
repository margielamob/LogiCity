...
def parse_arguments():
    ...
    parser.add_argument('--exp', type=str, default="collect_easymed_train")
    ...
    parser.add_argument('--config', default='config/tasks/Nav/easy_med/experts/expert_collect_train.yaml', help='Configure file for this RL exp.')
