...
def parse_arguments():
    ...
    parser.add_argument('--exp', type=str, default="easymed_bc_50")
    ...
    parser.add_argument('--config', default='config/tasks/Nav/easy_med/algo/bc_50.yaml', help='Configure file for this RL exp.')
