...
def parse_arguments():
    ...
    parser.add_argument('--exp', type=str, default="easymed_hri")
    ...
    parser.add_argument('--config', default='config/tasks/Nav/easy_med/algo/hritest.yaml', help='Configure file for this RL exp.')
