...
def parse_arguments():
    ...
    parser.add_argument('--exp', type=str, default="test_expert")
    ...
    parser.add_argument('--config', default='config/tasks/Nav/medium/experts/expert_test.yaml', help='Configure file for this RL exp.')
