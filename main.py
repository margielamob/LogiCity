...
def parse_arguments():
    ...
    parser.add_argument('--exp', type=str, default="easy_dqn_train")
    ...
    parser.add_argument('--config', default='config/tasks/Nav/easy/algo/nlmdqn.yaml', help='Configure file for this RL exp.')
