...
from logicity.rl_agent.policy import DQNNLMPolicy, QNetwork
...
SelfNLMDQN = TypeVar("SelfNLMDQN", bound="NLMDQN")


class NLMDQN(OffPolicyAlgorithm):
    """
    Deep Q-Network (DQN)
    ...
    def __init__(
        self,
        policy: Union[str, Type[DQNNLMPolicy]],
