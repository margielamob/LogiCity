...
from tasks.logic.neural.data import LogicDataset
...
def runner(args, logger, writer):
    ...
    input_sz += args.irr_c
    train_data = LogicDataset(data_X, data_Y, Xname, Yname, logger, False, args.uni_boundary, args.w_bernoulli, args.irr_c)
    train_loader = DataLoader(train_data, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
    # Load test data
    _, _, test_data_X, test_data_Y, _, _ = parse_pkl(args.test_data_path, logger)
    test_data = LogicDataset(test_data_X, test_data_Y, Xname, Yname, logger, True, args.uni_boundary, args.w_bernoulli, args.irr_c)
