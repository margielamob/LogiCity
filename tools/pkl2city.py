...
if __name__ == "__main__":
    ...
    parser.add_argument("--pkl", default='log_rl/easy_test_expert_1.pkl', help="Path to the folder containing image files.")
    parser.add_argument("--ego_id", type=int, default=9, help="which agent is ego agent. Visualize the ego agent's start and goal. This is layer_id")
