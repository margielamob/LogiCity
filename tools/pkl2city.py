...
if __name__ == "__main__":
    ...
    parser.add_argument("--pkl", default='log_rl/car_test_9.pkl', help="Path to the folder containing image files.")
    parser.add_argument("--ego_id", type=int, default=7, help="which agent is ego agent. Visualize the ego agent's start and goal. This is layer_id")
