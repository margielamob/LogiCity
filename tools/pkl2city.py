...
if __name__ == "__main__":
    ...
    parser.add_argument("--pkl", default='log_rl/easy_ppo3_1.pkl', help="Path to the folder containing image files.")
    ...
    parser.add_argument("--output_folder", default="vis_city_ppo", help="Output folder.")
