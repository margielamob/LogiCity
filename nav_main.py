...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_workers', type=int, default=64, help='Number of workers for the dataloader')
    ...
    parser.add_argument('--fov', type=int, default=112, help='Field of view of the agent')
