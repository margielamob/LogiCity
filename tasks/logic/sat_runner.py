...
def runner(args, logger, writer):
    ...
    train_data = LogicDatasetSAT(data_X, data_Y, Xname, Yname, logger, args.train_noise_std)
    train_loader = DataLoader(train_data, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
    # Load test data
    _, _, test_data_X, test_data_Y, _, _ = parse_pkl(args.test_data_path, logger)
    test_data = LogicDatasetSAT(test_data_X, test_data_Y, Xname, Yname, logger, args.test_noise_std)
