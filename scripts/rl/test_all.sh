...
for iter in 50000 160000 180000 210000 220000
do
python3 main.py --use_gym --config config/tasks/Nav/medium/algo/dreamertest.yaml --exp medium_dreamer5_test_${iter} \
    --checkpoint_path checkpoints/medium_dreamer_${iter}_steps.zip
done