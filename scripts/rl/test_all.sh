...
for iter in 40000 60000 80000
do
python3 main.py --config config/tasks/Nav/expert/algo/dreamer5_test.yaml --exp expert_dreamer5_test_${iter} \
    --checkpoint_path checkpoints/expert_mbrl_${iter}_steps.zip --use_gym
done