...
python3 tools/create_episode.py --config $CONFIG_FILE --exp "expert_episode_test_100" \
    --max_episodes 100
CONFIG_FILE="config/tasks/Nav/easy/experts/expert_episode_val.yaml"
python3 tools/create_episode.py --config $CONFIG_FILE --exp "expert_episode_val_40" \
    --max_episodes 40